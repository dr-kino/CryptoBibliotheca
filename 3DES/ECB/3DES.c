		         ...
		         char * bloco_saida)
{
  ...
  {desnbs(0,bloco_entrada,chave1,bloco_saida);
   desnbs(1,bloco_saida,  chave2,bloco_saida);
   desnbs(0,bloco_saida,  chave3,bloco_saida);
  }
  else
  {desnbs(1,bloco_entrada,chave3,bloco_saida);
   desnbs(0,bloco_saida,  chave2,bloco_saida);
   desnbs(1,bloco_saida,  chave1,bloco_saida);
  }
}
...
{ char bloco_entrada[9];
  ...
  // criptografar 
  modo = 0;
  Triplo_DES(modo,bloco_entrada,chave1,chave2,chave3,bloco_saida);
  bloco_saida[8]=0;
  ...
  Triplo_DES(modo,bloco_saida,chave1,chave2,chave3,bloco_entrada);
  bloco_entrada[8]=0;
